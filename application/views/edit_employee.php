        ...
        <div class="card-body>">
            ...
            <form action="<?php echo base_url('employee/update'); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="input_val[emp_lname]"   value="<?php echo $employee->emp_fname; ?>" id="lastName" placeholder="Enter your last name">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="email_pass" id="exampleInputPassword1" placeholder="Password">
                </div>
                <div class="form-group">
